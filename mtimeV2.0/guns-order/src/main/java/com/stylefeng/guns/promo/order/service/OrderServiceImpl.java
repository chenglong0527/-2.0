package com.stylefeng.guns.promo.order.service;

import com.alibaba.dubbo.config.annotation.Reference;
import com.alibaba.dubbo.config.annotation.Service;
import com.baomidou.mybatisplus.mapper.EntityWrapper;
import com.baomidou.mybatisplus.plugins.Page;
import com.stylefeng.guns.promo.common.persistence.dao.MoocOrderTMapper;
import com.stylefeng.guns.promo.common.persistence.model.MoocOrderT;
...
//        long time = System.currentTimeMillis() / 1000;
    ...
    public BaseRespVo getOrderInfo(Integer nowPage, Integer pageSize, Integer userId) {
        ...
        baseRespVo.setData(orderVos);
        baseRespVo.setNowPage(String.valueOf(nowPage));
        baseRespVo.setTotalPage(String.valueOf((int) Math.ceil((double) page.getTotal()/pageSize)));
        return baseRespVo;
    }
    ...
    public Integer getPayResult(String orderId) {
        return moocOrderTMapper.updateStatus(orderId);
    }
}
